...
public class SanPhamChiTietRespository extends daoDuAnMau<SanPhamChiTiet, String> {
    ...
    public void update(SanPhamChiTiet entity, String id) {
        try {
            ...
            Logger.getLogger(SanPhamChiTietRespository.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
