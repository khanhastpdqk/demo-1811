...
public class NhaSXRespository extends daoDuAnMau<NhaSX, String> {
    ...
    public List<NhaSX> selectBySql(String sql, Object... args) {
        ...
        try {
            ...
            Logger.getLogger(NhaSXRespository.class.getName()).log(Level.SEVERE, null, ex);
        }
        return listNsx;
    }
